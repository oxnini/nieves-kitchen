 ...
 *  secondary = cobalt text with a 2px cobalt inset ring, transparent fill
...
const VARIANTS = {
  ...
  secondary:
    'text-cobalt bg-transparent shadow-[inset_0_0_0_2px_var(--color-cobalt)] hover:bg-cobalt/[0.06]',
