...
export default function CookedButton({ recipe }: { recipe: Recipe }) {
  ...
  // session" the instant the page loads.
    ...
    <>
      <div className="flex flex-col items-center gap-2.5 w-full">
        <motion.button
          ...
          aria-label={isStamped ? 'Cooked, recorded in your passport' : isPending ? 'Logging cook' : !sessionReady ? 'Preparing your passport' : 'I cooked this, add to passport'}
        ...
        >
          ...
          {!isStamped && !isPending && sessionReady && (
            <span
              aria-hidden
          ...
          <span className="relative flex flex-col items-center justify-center gap-1.5 py-4 px-6">
            ...
            <AnimatePresence mode="wait" initial={false}>
              <motion.span
                key={isPending ? 'pending' : isStamped ? 'stamped' : !sessionReady ? 'preparing' : 'idle'}
