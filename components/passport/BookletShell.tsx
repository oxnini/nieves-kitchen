  ...
  return (
    ...
    >
      ...
      <PageTurnInkMark
        ...
        className="max-sm:hidden absolute top-1/2 -translate-y-1/2 -left-14 sm:-left-16 z-20"
      />
      <PageTurnInkMark
        direction="next"
        onClick={onNext}
        disabled={!canNext || navDisabled}
        className="max-sm:hidden absolute top-1/2 -translate-y-1/2 -right-14 sm:-right-16 z-20"
      />
    </div>
  );
}
