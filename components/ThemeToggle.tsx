...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex items-center justify-center w-9 h-9 rounded-full text-[#B5AAA6] hover:bg-brown-medium/30 hover:text-parchment transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-terracotta"
    >
